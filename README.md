...
- ???, 2014: New v0.2.0 released. Now possible to also render text anywhere on the map (however, potential error with PIL if you installed PIL from source without libfreetype). Also, possible to render individual features, not only entire shapefiles. Setting the renderer to "PIL" uses either the oldstyle PIL library or the more modern fork Pillow. 
...
- [Advanced Usage](#advanced-usage)
  ...
  - [Adding Flavor to Your Map](#adding-flavor-to-your-map)
